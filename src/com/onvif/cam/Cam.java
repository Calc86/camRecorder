...
public class Cam {
    ...
    private void setEndpoints() throws IOException {
        ...
        Response<GetCapabilitiesResponse> r = new Response<GetCapabilitiesResponse>();
    ...
    private void setProfiles() throws IOException {
        ...
        Response<GetProfilesResponse> r = new Response<GetProfilesResponse>();
    ...
    public GetStreamUriResponse getStreamUri(Profile profile) throws IOException {
        ...
        Response<GetStreamUriResponse> r = new Response<GetStreamUriResponse>();
    ...
    public GetSnapshotUriResponse getSnapshotUri(Profile profile) throws IOException {
        ...
        Response<GetSnapshotUriResponse> r = new Response<GetSnapshotUriResponse>();
        return r.getResponse(response);
    }
